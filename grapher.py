...
peril_current = [330]*11+[200]*2

resistances_series = [3.16, 2.43, 1.73, 1.06, 0.59, 0.265, 0, 0.97, 0.55, 0.35, 0.15, 0.0, 0.0]
voltages = [""]*13
engine_res_coef = [4]*7+[1]*6
engine_eds_coef = [4]*7+[2]*6
funny_thing_i_forgor = [1]*7+[2]*6
spec_divide = [1]*7+[2]*6
v = [182,214,246,278,310,342,375,450,525,600,675,750,750]
f = [0]*12+[0.15]
...
def calc():
    ...
    for velocity in range(600):
        ...
        amps = (1500-engine_eds_coef[rk]*rads*eng_const*(1-f[rk]))/(engine_res_coef[rk]*eng_res+resistances_series[rk])/funny_thing_i_forgor[rk]
